...
<?php if ( have_comments() ) : ?>
  <a class="btn btn-primary" data-toggle="collapse" href="#loadcomments1" aria-expanded="false" aria-controls="loadcomments1">Load Comments</a>
<?php endif; ?>
  <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#loadform2" aria-expanded="false" aria-controls="loadform2">Leave Comment</button>
</p>
	...
	<div class="card card-body">
		...
		<?php if ( have_comments() ) : ?>
			...
			<?php
				...
				if ( 1 === $comments_number ) {
					...
					printf( _x( 'One thought on “%s”', 'comments title', 'bootbam' ), get_the_title() );
				} else {
					printf(
		...
		<?php the_comments_navigation();
			...
			<?php if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
				<div class="alert alert-warning"><p><?php _e( 'Comments are closed.', 'bootbam' ); ?></p></div>
			<?php endif; ?>
